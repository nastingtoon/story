(() => {
  ...
  async function saveImage() {
    ...
    if (isIOS) {
      showToast('PNG сохранён в загрузки устройства. На iPhone веб-приложение не может положить файл прямо в Фото.', 3600);
    } else {
